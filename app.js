...
app.post('/expireproduct' ,function(req, res){
	...
	var pagecount = pagevalue *10;
	var endcount = totalrecord;
	var sql ="SELECT p.id,p.name,p.chemical_name,p.mrp,p.selling_price,p.company_name,p.quantity,p.expire_date,c.name as cname FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where expire_date <= '"+lastmonth+"' and added_by='"+addedby+"'  ORDER BY name ASC LIMIT "+pagecount+","+endcount+" ";
	connection.query(sql,function(error, result , fields){
        if(!!error){
            res.send({
				  "message":"Something Went wrong!",
...
app.post('/stockproductdata' ,function(req, res){
	...
	var pagecount = pagevalue *10;
	var endcount = totalrecord;
	var sql ="SELECT p.id,p.name,p.chemical_name,p.mrp,p.gst,p.selling_price,p.company_name,p.quantity,p.expire_date,c.name as cname,p.rack_no FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where quantity <=10 and added_by='"+addedby+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+" ";
	connection.query(sql,function(error, result , fields){
        if(!!error){
            res.send({
				  "message":"Something Went wrong!",
...
app.post('/product' ,function(req, res){
	...
	if(typevalue =="")
	{
		//var sql ="SELECT p.id as sno,p.name,p.chemical_name,p.mrp,p.selling_price,p.company_name,p.quantity,p.rack_no,p.expire_date,c.name as cname,p.gst,p.hsn_code,p.batch_no FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where added_by='"+addedby+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+"";
		var sql ="SELECT p.*,c.name as cname FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where p.added_by='"+addedby+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+"";
	} else{ 
		
		var sql ="SELECT p.*,c.name as cname FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where p.cat_id='"+typevalue+"' AND p.added_by='"+addedby+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+"";
...
app.post('/productsearchexpire' ,function(req, res){
    var totalrecord = req.body.totalrecord;
    var expiredatesearch = req.body.expiredatesearch;
    var addedby= req.body.addedby;
	var pagevalue= req.body.pagevalue;
	var pagecount = pagevalue *10;
	var endcount = totalrecord;
	//console.log(totalrecord);
	var sql ="SELECT * FROM ch_product where expire_date >= '"+expiredatesearch+"' AND added_by='"+addedby+"' ORDER BY name ASC LIMIT "+pagecount+","+endcount+"";
...
app.post('/productsearch' ,function(req, res){
	...
	if(typevalue =="")
	{
		//var sql ="SELECT p.id as sno,p.name,p.chemical_name,p.mrp,p.selling_price,p.company_name,p.quantity,p.rack_no,p.expire_date,c.name as cname,p.gst,p.hsn_code,p.batch_no FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where (p.name LIKE '%"+search+"%' OR p.chemical_name LIKE '%"+search+"%' or p.company_name LIKE '%"+search+"%' or p.rack_no LIKE '%"+search+"%' or p.batch_no LIKE '%"+search+"%' or p.barcode LIKE '%"+search+"%') and added_by='"+addedby+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+"";
		var sql ="SELECT * FROM ch_product as p where (p.name LIKE '%"+search+"%' OR p.chemical_name LIKE '%"+search+"%' or p.company_name LIKE '%"+search+"%' or p.rack_no LIKE '%"+search+"%' or p.batch_no LIKE '%"+search+"%' or p.barcode LIKE '%"+search+"%') and added_by='"+addedby+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+"";
	} else{ 
		
		var sql ="SELECT * FROM ch_product as p where (p.name LIKE '%"+search+"%' OR p.chemical_name LIKE '%"+search+"%' or p.company_name LIKE '%"+search+"%' or p.rack_no LIKE '%"+search+"%' or p.batch_no LIKE '%"+search+"%' or p.barcode LIKE '%"+search+"%') and added_by='"+addedby+"'and cat_id='"+typevalue+"' ORDER BY "+sortby+" ASC LIMIT "+pagecount+","+endcount+"";
...
app.post('/stocksearch' ,function(req, res){
	var search= req.body.value;
	var addedby= req.body.addedby;
	var sql ="SELECT p.id,p.name,p.chemical_name,p.mrp,p.gst,p.selling_price,p.company_name,p.quantity,p.expire_date,c.name as cname,p.rack_no FROM ch_product as p JOIN ch_category as c ON p.cat_id= c.id where (p.name LIKE '%"+search+"%' OR p.chemical_name LIKE '%"+search+"%' or p.company_name LIKE '%"+search+"%' or p.rack_no LIKE '%"+search+"%' or p.	batch_no LIKE '%"+search+"%' or p.barcode LIKE '%"+search+"%') and quantity <=10 and added_by='"+addedby+"' ORDER BY name ASC";
	connection.query(sql,function(error, result , fields){
...
app.post('/billingdata' ,function(req, res){
	...
	var sql ="SELECT bp.id as ids,p.id as pids,p.batch_no,bp.product_id,p.name,p.chemical_name,p.gst,p.mrp,p.Selling_price,bp.price,bp.totalprice,bp.quantity, p.perquantity,bp.loose,p.expire_date FROM  ch_addtocart as bp JOIN ch_product as p ON p.id= bp.product_id where bill_id='"+billid+"'";
	connection.query(sql,function(error, result , fields){
        if(!!error){
            res.send({
				  "message":"Something Went wrong!",
...
app.post('/viewbillingdata' ,function(req, res){
	var addedby= req.body.addedby;
	var id= req.body.id;
	var sql ="SELECT * FROM  ch_billing where addedby='"+addedby+"' and bill_no='"+id+"'";
	connection.query(sql,function(error, result , fields){
        if(!!error){
            res.send({
				  "message":"Something Went wrong!",
			...
			if(numRows > 0)
			{
				var billnos= result[0].id;
				//console.log(billnos);
				var sql ="SELECT bp.id as ids,p.id as pids,p.batch_no,bp.product_id,p.name ,p.chemical_name,p.gst,p.mrp,p.Selling_price,bp.price,bp.totalprice,bp.quantity,p.expire_date FROM  ch_billing as b JOIN ch_billing_product_list as bp ON b.id= bp.billing_id JOIN ch_product as p ON p.id= bp.product_id  where b.addedby='"+addedby+"' and bill_no='"+id+"'";
				connection.query(sql,function(error, results , fields){
					if(!!error){
						res.send({
							  "message":"Something Went wrong!",
...
app.post('/billingproductlist',function(req, res, next){ 
	...
	var invodate = req.body.invodate;
...
app.post('/getcustomerreport' ,function(req, res){
	...
	var pagecount = pagevalue *10;
	var endcount = totalrecord;
	var sql ="SELECT b.*,sum(pb.totalprice) as totalpur FROM   ch_billing as b JOIN ch_billing_product_list as pb ON b.id= pb.billing_id  where addedby ='"+added_by+"' GROUP BY billing_id LIMIT "+pagecount+","+endcount+" ";
	connection.query(sql,function(error, result , fields){
        if(!!error){
            res.send({
				  "message":"Something Went wrong!",
			...
			var Numrows =result.length;
			if(Numrows > 0){
				var sql ="SELECT count(*) as rows FROM  ch_billing as b JOIN ch_billing_product_list as pb ON b.id= pb.billing_id  where addedby ='"+added_by+"' ";
				connection.query(sql,function(error, results , fields){
					if(!!error){
						res.send({
							  "message":"Something Went wrong!",
							...
							if(numRow <= 0)
							{
								...
								connection.query('INSERT into ch_addtocart SET ?',addproduct, function (error, resultadd, fields) 
								{
									if (error) {
										...
										if(numRowsadd > 0)
										{
											var sql ="SELECT p.id,bp.id as ids,bp.product_id,p.name,p.chemical_name,p.gst,p.mrp,p.Selling_price,bp.price,bp.totalprice,bp.quantity,bp.loose,p.perquantity,p.batch_no,p.expire_date FROM  ch_addtocart as bp JOIN ch_product as p ON p.id= bp.product_id where bp.bill_id='"+billid+"' and bp.user_id='"+addedby+"'";
...
app.post('/checkvalue' ,function(req, res){
	var addedby = req.body.addedby;
	var invoiceno = req.body.invoiceno;
	var sql ="select * from ch_billing where addedby='"+addedby+"' and invoiceno='"+invoiceno+"'";
	connection.query(sql,function(error, result , fields){
        if(!!error){
            res.send({
				  "message":"Something Went wrong!",
			...
			if(Numrows > 0){
				res.send({
					  "message":"Invoice no already exit! Please change invoice no",
					  "status":'1',
					});
			}else{
				res.send({
				  "message":"Valid Invoice no",
				  "status":'2',
				});
			}
        } 
...
app.get('/imexcels',function(req,res){
	...
	rows.forEach((value)=>{
			console.log(value);
			 //var exdate =value[6];
			 var exdate ='2021-08-12 00:00:00';
			 //console.log(exdate);
			 var tcount =value[2] * 1;
			  product.push({cat_id:value[3],subcat_id:'',name:value[0],image:'',img_path:'',chemical_name:'',mrp:value[10],selling_price:value[5],available_price:'',gst:value[8],hsn_code:value[1],company_name:value[11],quantity:value[2],perquantity:1,totalcount:tcount,rack_no:'',batch_no:value[4],barcode:value[14],is_prescription:2,expire_date:exdate,available_date:'',created_date:today,modified_date:today,added_by:13});
...
app.post('/contactus', function(req, res){ 
	var data={
		...
		connection.query('INSERT INTO ch_contactus SET ?',data, function (error, result, fields) {
		if (error) {
			res.send({
			  "code":400,
			  "failed":error
...
app.post('/regtrial', function(req, res){ 
	...
	bcrypt.hash(req.body.password, saltRounds, function (err,hash) {
		...
		connection.query('INSERT INTO ch_users SET ?',data, function (error, result, fields) {
			if (error) {
				res.send({
				  "code":400,
				  "failed":error
...
app.post('/edituser' ,upload.single('image'),function(req, res){ 
	if(req.file ==undefined){
		...
		var id = req.body.id;
		connection.query('Update ch_users  SET ? where id =?',[category,id], function (error, result, fields) {
		if (error) {
			res.send({
			  "status":3,
			  "failed":"Something went wrong!!"
